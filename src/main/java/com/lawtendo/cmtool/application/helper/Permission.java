...
public class Permission {
	...
	public static List<String> getRights(String role){
		...
		if(permissionMap == null) {
			...
			guestRights.add("/doc/create");
			guestRights.add("/doc/getAllByUuid");
			...
			guestRights.add("/invoice/deleteByIuidAndCuidAndUuid");
			guestRights.add("/invoice/updateByIuidAndCuidAndUuid");
